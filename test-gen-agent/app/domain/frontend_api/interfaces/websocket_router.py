...
async def ws_export_report(websocket: WebSocket, report_id: str):
    ...
    try:
        ...
        if task:
            ...
            from app.domain.export_task.application.export_task_app_service import remove_task
...
def _wait_task_sync(report_id: str, timeout: float):
    from app.domain.export_task.application.export_task_app_service import wait_task
