...
from app.domain.identity.application.identity_app_service import organization_service
from app.domain.project.application.project_app_service import project_service
from app.domain.template.application.template_app_service import template_service
from app.domain.workflow.application.workflow_app_service import workflow_service
...
# 重启可读回，消灭假成功。
from app.domain.user_view.application.user_view_app_service import user_view_service
