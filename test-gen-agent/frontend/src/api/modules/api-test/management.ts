...
// 关注/取消关注接口定义（单端点 toggle，回读服务器侧真实关注状态）
export function toggleFollowDefinition<T = { followed?: boolean }>(id: string | number) {
  return MSR.get<T>({ url: ToggleFollowDefinitionUrl, params: id });
}
