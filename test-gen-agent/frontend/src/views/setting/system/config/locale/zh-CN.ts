export default {
  ...
  'system.config.page.themeTip': '平台主题色是指除了页面背景色之外的 TestPilot 紫色系颜色',
  ...
  'system.config.page.loginPreviewTip': 'tips:默认为 TestPilot 系统界面，支持自定义平台界面设置',
  ...
  'system.config.page.platformConfigTip': 'tips:默认为 TestPilot 系统界面，支持自定义界面设置',
  ...
  'system.config.auth.clientIdPlaceholder': '例如：testpilot',
  ...
  'system.config.auth.LDAPPropertyMapTip': '左侧键为 TestPilot 用户属性，右侧值为认证平台用户属性',
  ...
  'system.config.modelConfig.modelNameTooltip': 'TestPilot 中自定义的模型名称',
