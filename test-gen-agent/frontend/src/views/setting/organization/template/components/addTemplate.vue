    ...
    <div class="wrapper-preview">
      <div class="preview-left pr-4">
        <DefectTemplateLeftContent
          ...
          v-model:upload-img-file-ids="uploadBugImgFileIds"
          v-model:default-form="defaultBugForm"
          :mode="props.mode"
        />
        <CaseTemplateLeftContent
          v-else
          v-model:upload-img-file-ids="uploadCaseImgFileIds"
          v-model:default-form="defaultCaseForm"
          :mode="props.mode"
        />
      </div>
      <div class="preview-right px-4">
        ...
        <div class="flex items-center">
          ...
          <a-tooltip :content="t('system.orgTemplate.associatedHasField')" placement="top" effect="dark">
            <IconQuestionCircle
              class="mr-8 mt-1 h-[16px] w-[16px] text-[var(--color-text-4)] hover:text-[rgb(var(--primary-5))]"
            />
          </a-tooltip>
          ...
          <a-tooltip :content="t('system.orgTemplate.addFieldDesc')" placement="top" effect="dark">
            <IconQuestionCircle
              class="mt-1 h-[16px] w-[16px] text-[var(--color-text-4)] hover:text-[rgb(var(--primary-5))]"
            />
          </a-tooltip>
        </div>
      </div>
