    ...
    <div class="flex flex-col">
      <div class="flex items-center">
        ...
        <div
          class="button mr-1"
          :class="[
            projectDetail?.deleted
              ? 'delete-button'
              : projectDetail?.enable === false
                ? 'disabled-button'
                : 'enable-button',
          ]"
        >
      ...
      <a-tooltip v-if="projectDetail?.description" :content="projectDetail?.description">
        <div class="one-line-text text-[12px] text-[var(--color-text-4)]">{{ projectDetail?.description }}</div>
      </a-tooltip>
    </div>
  </div>
