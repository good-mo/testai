    ...
    >
      ...
      <div v-if="props.showPrePostRequest" class="mt-4">
        ...
        <a-tooltip position="br" :content="t('apiTestDebug.preconditionAssociateResultDesc')">
          <IconQuestionCircle class="ml-2 h-[16px] w-[16px] text-[var(--color-text-4)] hover:text-[rgb(var(--primary-5))]" />
          <template #content>
      ...
      <div class="flex items-center justify-between">
        ...
        <div v-if="props.showAssociatedScene" class="flex items-center">
          ...
          <a-tooltip position="br" :content="t('apiTestDebug.preconditionAssociateResultDesc')">
            <IconQuestionCircle
              class="ml-2 h-[16px] w-[16px] text-[var(--color-text-4)] hover:text-[rgb(var(--primary-5))]"
            />
          </a-tooltip>
        </div>
      </div>
