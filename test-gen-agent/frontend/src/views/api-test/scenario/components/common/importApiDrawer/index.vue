      ...
      <div class="flex h-[calc(100%-49px)]">
        <div v-show="!isAdvancedSearchMode" class="w-[300px] border-r border-[var(--color-text-n8)] p-[16px]">
          <div class="flex flex-col">
            ...
            <moduleTree
              ref="moduleTreeRef"
              v-model:checked-keys="currentUseTreeSelection.checkedKeys"
              v-model:half-checked-keys="currentUseTreeSelection.halfCheckedKeys"
              :type="activeKey"
        ...
        <div :class="[`table-container ${!isAdvancedSearchMode ? 'w-[calc(100%-300px)]' : 'w-full'}`]">
          <apiTable
            ref="apiTableRef"
            v-model:api-selected-modules-maps="apiUseTreeSelection.selectedModulesMaps.value"
            v-model:case-selected-modules-maps="caseUseTreeSelection.selectedModulesMaps.value"
            v-model:scenario-selected-modules-maps="scenarioUseTreeSelection.selectedModulesMaps.value"
            :module="activeModule"
            :type="activeKey"
            :protocol="protocol"
