        ...
        <template #content>
          <div v-for="item in switchList" :key="item.key" class="mb-[24px] flex items-center gap-[8px]">
            ...
            <a-tooltip :position="item.tooltipPosition">
              ...
              <IconQuestionCircle class="h-[16px] w-[16px] text-[var(--color-text-4)] hover:text-[rgb(var(--primary-5))]" />
            </a-tooltip>
          </div>
          <a-form-item
            field="passThreshold"
          ...
          >
            ...
            <template #label>
              ...
              <a-tooltip position="tl" :content="t('testPlan.planForm.passThresholdTip')">
                <IconQuestionCircle
                  class="h-[16px] w-[16px] text-[var(--color-text-4)] hover:text-[rgb(var(--primary-5))]"
                />
              </a-tooltip>
            </template>
          </a-form-item>
