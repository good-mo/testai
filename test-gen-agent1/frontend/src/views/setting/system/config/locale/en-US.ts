export default {
  ...
  'system.config.page.themeTip':
    'The platform theme color refers to the purple color of TestPilot except the page background color',
  ...
  'system.config.page.loginPreviewTip':
    'tips: The default is the TestPilot system interface, which supports custom platform interface settings',
  ...
  'system.config.page.platformConfigTip':
    'tips: TestPilot system interface by default, support for custom interface Settings',
  ...
  'system.config.auth.clientIdPlaceholder': 'eg: testpilot',
  ...
  'system.config.auth.LDAPPropertyMapTip':
    'The left key is the TestPilot user attribute, and the right value is the authentication platform user attribute',
  ...
  'system.config.modelConfig.modelNameTooltip': 'Custom model name in TestPilot',
