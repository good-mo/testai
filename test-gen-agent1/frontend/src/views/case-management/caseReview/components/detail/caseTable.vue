  ...
  <div class="h-full px-[24px] py-[16px]">
      ...
      >
        ...
        <template #reviewerTitle="{ columnConfig }">
          <div class="flex items-center gap-[4px]">
            ...
            <a-tooltip
              v-model:popup-visible="reviewerTitlePopupVisible"
    ...
    >
      ...
      <a-form ref="dialogFormRef" :model="dialogForm" layout="vertical">
        ...
        >
          <div class="flex w-full items-center">
            <MsRichText
              ...
              v-model:comment-ids="dialogForm.commentIds"
        ...
        >
          <MsSelect
            v-model:model-value="dialogForm.reviewer"
            mode="static"
...
<script setup lang="ts">
  ...
  // 列初始化不能放在 <script setup> 顶层 await（无 <Suspense> 边界会导致组件无法渲染），
  // 需在数据加载前完成列注册。
  onBeforeMount(async () => {
