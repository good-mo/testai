...
export enum AiCaseGenRouteEnum {
  AI_CASE_GEN = 'aiCaseGen',
  AI_CASE_GEN_INDEX = 'aiCaseGenIndex',
  AI_CASE_GEN_LOWCODE = 'aiCaseGenLowcode',
  AI_CASE_GEN_PROJECT = 'aiCaseGenProject',
}
