...
export default {
  message: {
    'menu.aiCaseGen': 'AI Test Generation',
    'menu.aiCaseGenIndex': 'Case Generation',
    'menu.aiCaseGenLowcode': 'Low-code Generation',
    'menu.aiCaseGenProject': 'Project Batch Generation',
